...
//        jLabel8.setPreferredSize(new java.awt.Dimension(150, 150));
        ...
        jLabel9.setText("Invalid given name. It should have 3 letters.");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(153, 51, 0));
        jLabel10.setText("Weak Password. Your password should " +
...
// Add listener for username validation
        ...
        try {
            File file = new File("db/systemAccounts.xlsx");
            Workbook workbook;
            Sheet sheet;
            ...
            if (file.exists()) {
                ...
                header.createCell(0).setCellValue("Given Name");
